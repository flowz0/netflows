      ...
      <main className="mt-8 px-6 max-w-7xl mx-auto cursor-default md:mt-16">
        ...
        <div className="mt-32 flex flex-col gap-y-16 md:gap-y-24">
          <ServiceSection
            ...
            buttonLabel="Start My Website Project"
            sectionId="web-design-development"
            img={WebDesignImg}
            flip
            />
          <ServiceSection
            ...
            buttonLabel="Build My Web Application"
            sectionId="custom-web-apps"
          ...
          <ServiceSection
            ...
            buttonLabel="Connect My Tools"
            sectionId="third-party-api"
          ...
          <ServiceSection
            ...
            buttonLabel="Host My Website or App"
            sectionId="fully-managed-hosting"
          ...
          <ServiceSection
            ...
            buttonLabel="Set Up My Domain"
            sectionId="domain-management"
          ...
          <ServiceSection
            ...
            buttonLabel="Keep My Platform Running Smoothly"
