...
export default function Step4({name, time, date, service}: Step4Props) {
  return (
    <div className="flex flex-col items-center mt-8 sm:mt-12">
      ...
      <p className="text-[hsl(0,0%,80%)] mt-4 max-w-md text-center">
        Congratulations, {name}! You successfully booked a consultation with Netflows for {service}. Make sure to set a reminder so you don&apos;t miss it.
      </p>
