...
export default function Process() {
  return (
    <section className="my-64 max-w-7xl mx-auto">
      ...
      <div className="mt-16 grid grid-cols-1 sm:grid-cols-2 md:gap-x-6 md:grid-cols-4">
        ...
        <ProcessCard
          step="02."
          title="Design"
          desc="Create a clean, user-friendly design file that aligns with your brand's identity and goals."
        />
        <ProcessCard
          step="03."
          title="Development"
          desc="Build responsive, fast, and secure web solutions with modern technologies."
        />
        <ProcessCard
          step="04."
          title="Launch"
          desc="After QA, we launch your solution and offer ongoing support to keep it running smoothly."
        />
      </div>
      <ProcessCTA />
    </section>
