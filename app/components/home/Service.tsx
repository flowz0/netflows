  ...
  return (
    <div className="rounded-xl cursor-pointer group sm:max-w-sm">
      <Image
        src={img}
        alt="Service image"
        className="object-cover h-64 w-full rounded-xl border border-[rgba(4,15,22,1.0)] shadow shadow-[#040F16]/70 sm:h-52"
        draggable={false}
      />
      <div className="bg-[#040F16] shadow shadow-[#040F16]/70 flex items-center gap-x-4 rounded-xl -translate-y-6 py-4 px-5">
