...
export default function CTA() {
  return (
    <section className="mt-32 px-6 max-w-7xl mx-auto relative md:mt-64">
      <div className="border bg-black5 border-black rounded-2xl p-6 sm:p-8 animate-drop-shadow sm:h-[400px] flex flex-col items-center justify-center cursor-default">
