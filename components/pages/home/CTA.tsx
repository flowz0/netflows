...
export default function CTA() {
  return (
    <section className="mt-32 px-6 max-w-7xl mx-auto md:mt-64">
      <div className="border border-black rounded-2xl p-8 sm:h-[400px] flex flex-col items-center justify-center cursor-default">
        ...
        <Link href="/booking" className="mt-8 md:mt-12">
          <Button text="Book Free Consultation" variant="gradient" />
        </Link>
      </div>
    </section>
  );
