    ...
    <div className="grid grid-cols-1">
        <div>
          ...
          <h1 className="text-black text-h3 font-bold font-nunito">
            Let&apos;s <span className="text-primary">Uncover</span> What {" "}
            <br className="hidden sm:inline-block" />
            Your <span className="text-primary">Business</span> Needs Online
          </h1>
          <p className="mt-4 max-w-2xl text-p font-inter text-black75">
        ...
        <div>
          ...
          <div className="mt-4 relative">
            ...
            <div className="pt-8 z-10">
              <p className="text-p font-inter text-black75">
