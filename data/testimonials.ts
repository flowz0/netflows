...
export const topRowReviews: Testimonial[] = [
  {
    id: 0,
...
export const bottomRowReviews: Testimonial[] = [
  {
    id: 0,
    review: "From first call to launch, it was smooth. They handled everything—design, development, even SEO best practices. Highly recommend.",
    reviewer: "Laura Kent",
